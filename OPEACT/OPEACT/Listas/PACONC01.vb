...
Public Class PACONC01
    ...
    Private Sub LlenarEncab()
        Try
            ...
            Do While SqlNextRow(Sqlconn) = MOREROWS
                ...
                lblPARTIDA_ORIGEN.Text = "Partida Trabajo:  " & SqlData(Sqlconn, 29).ToString
    ...
    Private Sub LlenarParam()
        ...
        Else
            MeterParam(3, Info, 1, "Monto $", 8, ALINEAR_DER, "Convert(Varchar, round(Convert(money,PARTIDA_CONTABLE_DET.MONTO / PARTIDA_CONTABLE_ENC.TASA_CAMBIO),2), 1)", 62, 10, 2, 0, 127)
        End If
