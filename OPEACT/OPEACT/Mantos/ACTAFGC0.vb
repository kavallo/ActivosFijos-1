Public Class ACTAFGC0
    ...
    Private Sub Leer()
        Try
            ...
            meteSQL(" where ACTIVOS_FIJOS_GEN.CODIGO_DE_ACTIVO = " & Scm(txtCodigoActivo.Text) & " and ACTIVOS_FIJOS_GEN.MEJORA_CORRELATIVO = " & sen(txtMejora.Text))
