...
Public Class ACTSEEM0
    ...
    Private Sub kPila(ByRef Acción As Short)
        ...
        If txtNO_ENDOSO.Text = " " Or txtNO_ENDOSO.Text = "" Then
            txtNO_ENDOSO.Text = "               "
        End If
    ...
    Private Sub LabelCodigo_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblTitCODIGO_DE_MONEDA.DoubleClick
    ...
    Private Sub Aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
        ...
        V = V & ", @ESTADO_POLIZA = 'A'"
        V = V & ", @ENDOSO_ANTERIOR = " & Scm(varENDOSO_ANTERIOR)
