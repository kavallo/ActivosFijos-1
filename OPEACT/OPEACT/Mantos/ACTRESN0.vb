...
Public Class ACTRESN0
    ...
    Private Sub ResponsableInicialLabel_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblRESP_INI.DoubleClick
        RESP_INI.GenerarConsulta()
    End Sub

    Private Sub ResponsableFinalLabel_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblRESP_FIN.DoubleClick
        RESP_FIN.GenerarConsulta()
    End Sub

    Private Sub Responsables_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RESP_INI.Leave, RESP_FIN.Leave
