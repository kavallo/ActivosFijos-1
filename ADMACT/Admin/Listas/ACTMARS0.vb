...
Public Class ACTMARS0
    ...
    Private Sub LlenarParam()
        ...
        MeterParam(1, Info, 1, "Marcas", 10, InfoLista.TipoAlineacion.ALINEAR_IZQ, "CODIGO_MARCA", 39, 10, 0, 1, 31)
        MeterParam(2, Info, 1, "Descripcion", 60, InfoLista.TipoAlineacion.ALINEAR_IZQ, "DESCRIPCION_MARCA", 39, 60, 0, 0, 12)

        'snCampos = CrearParam(Info, Me)
        Order_By = " order by CODIGO_MARCA "
        snTabla = "MARCAS"
    End Sub

    Private Sub Modificar()
        If LlenarLlaves() Then
            Dim frmModificar As New ACTMARM0
            With frmModificar
    ...
    Private Sub Agregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAgregar.Click, mnuAgregar.Click
        Dim frmAgregar As New ACTMARM0
        With frmAgregar
