...
Public Class ACTTSAS0
    ...
    Private Sub LlenarParam()
        ...
        MeterParam(1, Info, 1, "Tipo Servicio", 10, ALINEAR_IZQ, "TIPO_SERVICIO", 5, 10, 0, 1, 35)
        MeterParam(2, Info, 1, "Descripcion", 30, ALINEAR_IZQ, "DESCRIPCION_SERVICIO", 10, 40, 0, 0, 12)
        MeterParam(3, Info, 1, "Clase Servicio", 8, ALINEAR_IZQ, "CLASE_DE_SERVICIO", 10, 1, 0, 0, 36)

        snTabla = "TIPOS_DE_SERVICIOS"
    End Sub
    ...
    Private Sub CambioLista()
        ...
        For Each fila As DataGridViewRow In Me._gridDeData.Rows
            ...
            Select Case valor
                Case "C"
                    fila.Cells(2).Value = Citi.Synergia.Traductor.Idiomas.GetMensaje(70, "C - Correctivo")
                Case "P"
                    fila.Cells(2).Value = Citi.Synergia.Traductor.Idiomas.GetMensaje(71, "P - Preventivo")
            End Select
        Next
    End Sub
    ...
    Private Sub Modificar()
        If LlenarLlaves() Then
            Dim frmModificar As New ACTTSAM0
            With frmModificar
    ...
    Private Sub Agregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAgregar.Click, mnuAgregar.Click
        Dim frmAgregar As New ACTTSAM0
        With frmAgregar
