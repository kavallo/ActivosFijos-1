...
Public Class ACTPRV
    ...
    Private Sub LlenarParam()
        ...
        MeterParam(1, Info, 1, "Codigo", 9, ALINEAR_IZQ, "CODIGO_CLASE_PROVEED", 47, 5, 0, 1, 21)
        MeterParam(2, Info, 1, "Descripcion", 40, ALINEAR_IZQ, "DESCRIPCION_CLASE", 39, 40, 0, 0, 12)

        snTabla = "CLASE_PROVEEDOR"
    End Sub

    Private Sub Modificar()
        If LlenarLlaves() Then
            Dim frmModificar As New ACTPRVB
            With frmModificar
