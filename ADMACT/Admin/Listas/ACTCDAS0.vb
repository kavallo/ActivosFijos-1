...
Public Class ACTCDAS0
    ...
    Private Sub LlenarParam()
        ...
        MeterParam(1, Info, 1, "Categoria", 9, ALINEAR_IZQ, "CATEGORIA_ID", 47, 5, 0, 1, 28)
        MeterParam(2, Info, 1, "Descripcion", 40, ALINEAR_IZQ, "CATEGORIA_DESC", 39, 40, 0, 0, 12)

        snTabla = "ACT_CATEGORIAS"
    End Sub

    Private Sub Modificar()
        If LlenarLlaves() Then
            Dim frmModificar As New ACTCDAM0
            With frmModificar
    ...
    Private Sub Agregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAgregar.Click, mnuAgregar.Click
        Dim frmAgregar As New ACTCDAM0
        With frmAgregar
