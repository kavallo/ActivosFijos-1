...
Public Class ACTVCDS0
    ...
    Private Sub LlenarEncabezado()
        ...
        If Not String.IsNullOrEmpty(TraeDato("Select CAMPO_NOMBRE From ACT_CAMPO Where CAMPO_ID = " + Scm(CampoID))) Then
            lblCAMPO_NOMBRE.Text = TraeDato("Select CAMPO_NOMBRE From ACT_CAMPO Where CAMPO_ID = " + Scm(CampoID)).ToString
        End If
    End Sub
    ...
    Private Sub LlenarParam()
        ...
        MeterParam(1, Info, 1, "Valor", 15, ALINEAR_IZQ, "CAMPO_VALOR", 39, 10, 0, 1, 38)
        MeterParam(2, Info, 1, "Descripcion", 40, ALINEAR_IZQ, "CAMPO_DESCRIPCION", 39, 40, 0, 0, 12)

        snCond = " Where ACT_CAMPOS_LV.CAMPO_ID = " + Scm(CampoID)
        snTabla = "ACT_CAMPOS_LV"
    End Sub

    Private Sub Modificar()
        If LlenarLlaves() Then
            Dim frmModificar As New ACTVCDM0
            With frmModificar
                .CampoID = CampoID
    ...
    Private Sub Agregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAgregar.Click, mnuAgregar.Click
        Dim frmAgregar As New ACTVCDM0
        With frmAgregar
            .CampoID = CampoID
