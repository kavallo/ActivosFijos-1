...
Public Class CONEPCC0
    ...
    Private Sub LlenarEncab()
        Try
            ...
            With comando
                ...
                .Parameters.Add("@origen1", SqlDbType.Char, 15).Value = lblORIGEN_1.Text
                .Parameters.Add("@origen2", SqlDbType.Char, 15).Value = lblORIGEN_2.Text
                .Parameters.Add("@origen3", SqlDbType.Char, 15).Value = lblORIGEN_3.Text
                .Parameters.Add("@origen4", SqlDbType.Char, 15).Value = lblORIGEN_4.Text
                .Parameters.Add("@origen5", SqlDbType.Char, 15).Value = lblORIGEN_5.Text
                .Parameters.Add("@origen6", SqlDbType.Char, 15).Value = lblORIGEN_6.Text
    ...
    Private Sub LlenarParam()
        ...
        Else
            MeterParam(6, Info, 1, "Monto $", 14, ALINEAR_DER, "Convert(Varchar, round(Convert(money,PARTIDAS_CONSOL_DET.MONTO / PARTIDAS_CONSOL_ENC.TASA_CAMBIO),2), 1)", 62, 14, 2, 0, 301)
        End If
    ...
    Private Sub Consultar()
        ...
        If Not String.IsNullOrEmpty(TraeDato("select Count(1) From PARTIDAS_TRABAJO_ENC Where CONSOLIDACION_ID = " & sen(varConsolidacionId))) Then
            If Val(TraeDato("select Count(1) From PARTIDAS_TRABAJO_ENC Where CONSOLIDACION_ID = " & sen(varConsolidacionId))) > 0 Then
        ...
        If Not String.IsNullOrEmpty(TraeDato("select Count(1) From PARTIDA_CONTABLE_ENC Where CONSOLIDACION_ID = " & sen(varConsolidacionId))) Then
            If Val(TraeDato("select Count(1) From PARTIDA_CONTABLE_ENC Where CONSOLIDACION_ID = " & sen(varConsolidacionId))) > 0 Then
