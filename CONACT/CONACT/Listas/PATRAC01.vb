...
Public Class PATRAC01
    ...
    Private Sub LlenarParam()
        ...
        Else
            MeterParam(3, Info, 1, "Monto $", 8, ALINEAR_DER, "Convert(VARCHAR, round(Convert(money,PARTIDAS_TRABAJO_DET.MONTO / PARTIDAS_TRABAJO_ENC.TASA_CAMBIO),2), 1)", 62, 10, 2, 0, 301)
        End If
