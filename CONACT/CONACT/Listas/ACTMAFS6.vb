...
Public Class ACTMAFS6
    ...
    Private Sub LlenarEncabezado()
        lblCodigoDivision.Text = CodigoDivision
        lblDescripcionDivision.Text = DescripcionesDB.Division(CodigoDivision)
    End Sub
    ...
    Private Sub LlenarParam()
        ...
        MeterParam(2, Info, 1, "Mejoras", 5, ALINEAR_DER, "MEJORA_CORRELATIVO", 56, 5, 0, 2, 115)
