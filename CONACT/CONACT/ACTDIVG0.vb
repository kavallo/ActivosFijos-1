...
Public Class ACTDIVG0
    ...
    Private Sub SqlLlenaGrid()
        Try
            ...
            With comando
                ...
                .CommandText = "Totales_Activos_Por_Division"
            End With
    ...
    Private Function F_LlenaGrid() As Boolean
        ...
        If Not Me._dsData Is Nothing Then
            If Me._dsData.Tables.Count > 0 Then
                ...
                With columna
                    ...
                    .ReadOnly = True
                    .HeaderText = Citi.Synergia.Traductor.Idiomas.GetMensaje(39, "Divisiones")
                    .Frozen = True
                End With
    ...
    Private Sub BotonImprime_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BotonExportarAExcel.Click, mnuExportarAExcel.Click
        ...
        With dlgGuardar
            ...
            .DefaultExt = ".xls"
            .FileName = Citi.Synergia.Traductor.Idiomas.GetMensaje(39, "Divisiones")
        ...
        With titulosGrid
            .Add(Citi.Synergia.Traductor.Idiomas.GetMensaje(39, "Divisiones"))
        End With
